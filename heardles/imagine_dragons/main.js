...
"Hole Inside Our Chests - Imagine Dragons",
...
"Continual (feat. Cory Henry) - Imagine Dragons, Cory Henry",
...
"The Unknown - Imagine Dragons",
      ...
      subscribe: ue(
        [
          ...
          },
          {
            ...
            answer: "Ferris Wheel - Imagine Dragons",
          },
          {
            url: "https://soundcloud.com/imaginedragons/crushed-1",
            answer: "Crushed - Imagine Dragons",
          },
          {
  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
          (n.innerHTML =
            '<b class="mb-3">The Heardle has been reset with the songs changing their order and your scores being also reset because the list reached the end. Thanks a lot for playing the Heardle!</b> </p>\n\n<p class="mb-3">A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a>,  but for ' + artist + ' songs.</p> \n\n<p class="mb-3">Each ' + artist + ' Heardle is randomly chosen from ' + artist + '\'s discography.</p> \n\n\n\n <p class="mb-3">Want to make your own Heardle? Check out my <a href="https://github.com/aabrahamian/aabrahamian.github.io/heardles/imagine_dragons">Github Page</a>  </p>  \n\n\n\n <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">Soundcloud</a>,\n    <a href="https://svelte.dev">Svelte</a>,\n    <a href="https://tailwindcss.com">Tailwind</a>,\n    <a href="https://fonts.google.com/noto/specimen/Noto+Serif+Display">Noto Serif Display</a>, <a href="https://fonts.google.com/noto/specimen/Noto+Sans">Noto Sans</a>,\n    <a href="https://iconsvg.xyz">IconSVG</a>, <a href="https://momentjs.com">momentjs</a>,\n    <a href="https://tarekraafat.github.io/autoComplete.js/#/">autocomplete.js</a>, and powered by <a href="https://github.com/">Github Pages</a>.'),
          M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
      ...
      [
        ...
        () => {
          ...
          let o =
            ...
            t +
            "\n\n" 
             + "https://github.com/aabrahamian/aabrahamian.github.io/heardles/imagine_dragons/"
          if (
            !navigator.share ||
  ...
  function jn(e, t, n) {
	...
	// use chance library to randomize each "cycle" so the songs are 
	//  not always in the same order between cycles
	//  play exactly once in the cycle
	let chance = new Chance(Math.floor(a / s.length));
	s = chance.shuffle(s);
	// this prevents indexing outside the array after we have gone through at least one cycle
	a = a % s.length
